...
const translates = {
	...
	dcsbguyi: "孤熠",
	dcsbguyi_info: "锁定技，分发手牌后，你选择一张手牌并标记为“熠”。每回合限七次，“熠”牌离开手牌区后，观看牌堆顶X张牌，选择其中一张牌获得并标记为“熠”，然后将其余牌以任意顺序放回牌堆顶（X为本轮触发此效果的次数且至多为7）。每回合结束时，若你手牌中没有“熠”牌，你摸一张牌并标记为“熠”。每轮结束时，若你本轮造成过伤害，你摸一张牌并标记为“熠”。",
	...
	old_dcjuanji: "狷急",
	old_dcjuanji_info: "①摸牌阶段开始时，你可以摸体力上限张牌。②出牌阶段每项限一次，你可以：1.令你与一名其他角色各恢复X点体力，然后对你与其各造成X点伤害；2.弃置至多X名其他角色各一张牌；3.摸X张牌，然后你弃置等量张牌（X为本回合此技能发动次数）。③弃牌阶段开始时，若你的手牌数不等于手牌上限，你可以将手牌调整至手牌上限，然后弃置一名角色区域内至多两张牌。",
	old_dcrenshuang: "纫霜",
	old_dcrenshuang_info: "锁定技。①每轮你首次进入濒死状态时，将体力回复至1点；你前三次以此法回复体力后，增加1点体力上限。②你的体力值变为1时，复原武将牌并视为使用一张普通锦囊牌（每种牌名每轮限一次）。",
	x_dc_falu: "法箓",
