...
const translates = {
	...
	olsbzhitian: "知天",
	olsbzhitian_info: "出牌阶段，牌堆顶的七张牌对你可见。你的【火攻】结算中，你可观看并选择牌堆顶七张牌中的一张牌代替【火攻】弃牌。每轮开始时，此技能的可见牌与观看牌数重置为7。",
	olsbwujing: "武靖",
	olsbwujing_info: "锁定技，你的回合内，有牌不因使用而进入弃牌堆后，你使用的下一张牌无次数限制；每回合首次有不为手牌的牌进入弃牌堆后，你摸一张牌。",
	olsbzhijue: "智绝",
	olsbzhijue_info: "转换技，阳：出牌阶段，你可将牌堆顶的一张牌当【火攻】使用；阴：将一种花色的手牌置入弃牌堆（每种花色每回合限一次），然后可视为使用其中一张基本牌或普通锦囊牌。若你以此法未造成伤害，你令〖知天〗可见牌与观看牌数-1（至多减至1），然后你摸两张牌。",
	ol_madai: "OL界马岱",
	ol_madai_prefix: "OL界",
	olqianxi: "潜袭",
